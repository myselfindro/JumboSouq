...
public class WeeklyDealsRecyclerAdapter extends RecyclerView.Adapter<WeeklyDealsRecyclerAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<WeeklyModel> weeklyAdapterArrayList;
    Context ctx;

    public WeeklyDealsRecyclerAdapter(Context ctx, ArrayList<WeeklyModel> weeklyAdapterArrayList) {
    ...
    @NotNull
    @Override
    public WeeklyDealsRecyclerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.rv_weeklydeals, parent, false);
        WeeklyDealsRecyclerAdapter.MyViewHolder holder = new WeeklyDealsRecyclerAdapter.MyViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull WeeklyDealsRecyclerAdapter.MyViewHolder holder, int position) {
